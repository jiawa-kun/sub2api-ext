...
func TestResponsiveTaskHistoryAndPaginationContracts(t *testing.T) {
	files := map[string][]string{
		...
		"static/admin.html":       {"lotteryDrawPage={offset:0,limit:10", "ledgerPage={offset:0, limit:10", "<option value=\"10\">10条/页</option>", "id=\"tutorialVisual\"", "contenteditable=\"true\"", "btnTutorialLink", "btnTutorialSource", "insertTutorialLink", "id=\"sec-creative\"", "./api/admin/creative/users", "./api/admin/creative/jobs?'+query.toString()", "jobPageSize:10", "data-creative-work-view", "id=\"creativeJobUser\"", "id=\"creativeWorkViewer\"", "api_key:pool?'':el('creativeProviderKey')", "同步外部模型", "用户自有 Key", "['480p','720p','1080p']", "价格为 0 时不开放该档"},
